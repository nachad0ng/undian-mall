...
<body class="border-top-wide border-primary d-flex flex-column antialiased">
    @auth
        <!-- Navbar -->
            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#navbar-notifications" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" role="button" aria-label="Show notifications">
